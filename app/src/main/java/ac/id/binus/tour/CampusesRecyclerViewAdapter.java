...
public class CampusesRecyclerViewAdapter extends RecyclerView.Adapter<CampusesRecyclerViewAdapter.ViewHolder> {
    ...
    CampusesRecyclerViewAdapter(Context context, List<Integer> locationImages, List<String> locationNames) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.recyclerview_campuses, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            textViewLocation = itemView.findViewById(R.id.rv_campus_name);
            imageViewLocation = itemView.findViewById(R.id.rv_campus_image);
